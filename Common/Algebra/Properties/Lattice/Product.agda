...
module Common.Algebra.Properties.Lattice.Product
   {𝑎 𝑏 𝑙₁ 𝑙₂}
   {A : Set 𝑎} {B : Set 𝑏}
   {_≈₁_ : Rel A 𝑙₁} {_∨₁_ _∧₁_}
   {_≈₂_ : Rel B 𝑙₂} {_∨₂_ _∧₂_}
   ...
   open import Common
   import Common.Algebra.Properties.Lattice
   ...
   private
      open module LatticeProps =
         Common.Algebra.Properties.Lattice (record { isLattice = isLattice }) public
